        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data[1].length; i++) {
                    $("#search-result").append("<div class='col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-8 col-md-offset-2 result'><div><h3>" + data[1][i] + "</h3><p>" + data[2][i] + "</p><a href=" + data[3][i] + " target='_blank'>" + data[3][i] + "</a></div></div>");
                }
                $("#search-for").val("");
